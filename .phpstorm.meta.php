...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/sica/Documents/mds/w9-applications/simplyfact/simplyFact/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/sica/Documents/mds/w9-applications/simplyfact/simplyFact/public/storage','fortify.guard','fortify.middleware',
...
'home','users.index','users.create','users.store','users.show',
'users.edit','users.update','users.destroy','expenses-claims.index','expenses-claims.create',
'expenses-claims.store','expenses-claims.show','expenses-claims.edit','expenses-claims.update','expenses-claims.destroy',
'meals.index','meals.create','meals.store','meals.show','meals.edit',
'meals.update','meals.destroy','expenses-claims.flow.start','expenses-claims.flow.next','expenses-claims.flow.enter-child',
'expenses-claims.flow.return-parent','expenses-claims.flow.complete-step','expenses-claims.flow.done','profile.edit',
